const interfaceGraficaEditor = `<div id="editor">
    <section id="menu">
...
<div id="myModal" class="modal">
    <div class="modal-content">
        ...
        <p style="font-size: 9px; margin-bottom:10px; border: 1px solid red; padding: 4px; border-radius: 3px;">Essas
            configurações serão aplicadas somente na criação de uma nova página. Após a criação da página, é impossível
            a alteração da margem!</p>
                ...
                <div class="sectionConfig">
                    <div class="templatemodelbackground separatorConfigItems">
                        <label for="templatemodelbackgroundBTN">
                            ...
                            <div style="font-size: 9px; margin:5px; padding: 2px;">
                                <p>Inserir uma imagem template. É possível alterar a qualquer momento.</p>
                                <p>A imagem template não será salva. Carregue novamente sempre que precisar.</p>
                            </div>
                        </label>
                        <input class="btnConfigModal" type="file" name="templatemodelbackgroundBTN"
                            id="templatemodelbackgroundBTN">
                        <p style="font-size: 11px; margin:5px;">OU</p>
                        <input style="width: 100%;" type="text" name="templatemodelbackgroundTEXT"
                            id="templatemodelbackgroundTEXT" placeholder="URL do template aqui!">
                    </div>
